...
| [MATH.md](MATH.md)                             | You want the equations, utility model, decision curves, and code-level negotiation math in one place         |
...
- Negotiation math and formulas live in [MATH.md](MATH.md)
